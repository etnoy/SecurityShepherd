 ...
 * 
 * import org.owasp.securityshepherd.model.User; import
 * org.owasp.securityshepherd.model.User.UserBuilder; import
 ...
 * 
 * @Repository public class UserRepository implements NameIdDao<User> {
 * 
 ...
 * }
 * 
 * @Override public boolean existsById(String id) { User.validateId(id);
 * 
 * SqlParameterSource namedParameters = new
 * MapSqlParameterSource().addValue("id", id);
 * 
 * return namedParameterJdbcTemplate.
 * queryForObject("SELECT count(id) FROM core.users WHERE id = :id",
 * namedParameters, Integer.class) > 0; }
 * 
 * @Override public boolean existsByName(String name) { User.validateName(name);
 * 
 * SqlParameterSource namedParameters = new
 * MapSqlParameterSource().addValue("name", name);
 * 
 * return namedParameterJdbcTemplate.
 * queryForObject("SELECT count(name) FROM core.users WHERE name = :name",
 * namedParameters, Integer.class) > 0; }
 * 
 * @Override public long count() { SqlParameterSource namedParameters = new
 * MapSqlParameterSource();
 * 
 * return
 * namedParameterJdbcTemplate.queryForObject("SELECT count(id) FROM core.users",
 * namedParameters, Integer.class); }
 * 
 * public void save(User user) {
 * 
 * String createQuery =
 * "INSERT INTO core.users (id, name, classId, password, role, suspendedUntil, email, loginType, temporaryPassword, temporaryUsername, score, goldMedals, silverMedals, bronzeMedals, badSubmissionCount, badLoginCount) VALUES (:id, :name, :classId, :password, :role, :suspendedUntil, :email, :loginType, :temporaryPassword, :temporaryUsername, :score, :goldMedals, :silverMedals, :bronzeMedals, :badSubmissionCount, :badLoginCount)"
 * ;
 * 
 ...
 * 
 * namedParameterJdbcTemplate.update("DELETE FROM core.users ", new
 * MapSqlParameterSource()); }
 * 
 * @Override public void deleteById(String id) { User.validateId(id);
 * 
 * SqlParameterSource namedParameters = new
 * MapSqlParameterSource().addValue("id", id);
 * 
 * namedParameterJdbcTemplate.update("DELETE FROM core.users WHERE id = :id",
 * namedParameters);
 * 
 * }
 * 
 * @Override public void deleteByName(String name) { User.validateName(name);
 * 
 * SqlParameterSource namedParameters = new
 * MapSqlParameterSource().addValue("name", name);
 * 
 * namedParameterJdbcTemplate.update("DELETE FROM core.users WHERE name = :name"
 * , namedParameters); }
 * 
 ...
 * queryForObject("SELECT * FROM core.users WHERE id = :id", namedParameters,
 * new UserRowMapper()));
 * 
 * }
 * 
 * @Override public Optional<User> findByName(String name) {
 ...
 * 
 * return Optional.ofNullable(namedParameterJdbcTemplate.
 * queryForObject("SELECT * FROM core.users WHERE name = :name",
 * namedParameters, new UserRowMapper())); }
 * 
 * @Override public List<User> findAll() {
 * 
 * return namedParameterJdbcTemplate.query("SELECT * FROM core.users", new
 * MapSqlParameterSource(), new UserRowMapper()); }
 * 
 * 
 ...
 * 
 * String renameQuery =
 * "UPDATE core.users SET name=:newName WHERE name = :name";
 * 
 ...
 * 
 * 
 * @Override public Iterable<User> findAll(Sort sort) { // TODO Auto-generated
 ...
 * 
 * @Override public Iterable<User> findAllById(Iterable<String> ids) { // TODO
 * Auto-generated method stub return null; }
 * 
