...
class UserTest {
  ...
  void buildDisplayName_ValidDisplayName_BuildsUser() {
    ...
    for (final String displayName : TestUtils.STRINGS) {
      final User user =
          userBuilder.key(TestUtils.INITIAL_BYTE_ARRAY).displayName(displayName).build();
  ...
  void toString_ValidData_AsExpected() {
    final User user =
        User.builder().key(TestUtils.INITIAL_BYTE_ARRAY).displayName("TestUser").build();
  ...
  void withClassId_ValidClassId_ChangesClassId() {
    final User user =
        User.builder()
            .displayName("TestUser")
            .key(TestUtils.INITIAL_BYTE_ARRAY)
            .classId(TestUtils.INITIAL_LONG)
            .build();
  ...
  void withDisplayName_ValidDisplayName_ChangesDisplayName() {
    final User user =
        User.builder()
            .key(TestUtils.INITIAL_BYTE_ARRAY)
            .displayName(TestUtils.INITIAL_STRING)
            .build();
  ...
  void withEmail_ValidEmail_ChangesEmail() {
    final User user =
        User.builder()
            .displayName("TestUser")
            .key(TestUtils.INITIAL_BYTE_ARRAY)
            .email(TestUtils.INITIAL_STRING)
            .build();
  ...
  void withNotBanned_ValidBoolean_ChangesIsAdmin() {
    final User user =
        User.builder()
            .key(TestUtils.INITIAL_BYTE_ARRAY)
            .isNotBanned(TestUtils.INITIAL_BOOLEAN)
            .displayName("TestUser")
            .build();
